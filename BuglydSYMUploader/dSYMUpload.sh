...
#
# #
BUGLY_APP_ID="7baefa5def"
# #
BUGLY_APP_KEY="34fb7230-d799-40b6-9824-e3b0c334743d"
# #
BUNDLE_IDENTIFIER="me.chaosky.WorldPictorial"
# #
UPLOAD_DSYM_ONLY=1
#
...
BUGLY_SYMBOL_JAR_PATH="$(dirname "$0")/buglySymboliOS.jar"
# 查找添加到系统目录的jar工具
