...
class ArticleDetailViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    func loadArticleModel() {
        headerImageView.kf.setImage(with: URL(string: articleModel.image_url!), placeholder: Image(named: "Placeholder"), options: [.transition(.fade(0.5))], progressBlock: nil, completionHandler: nil)
